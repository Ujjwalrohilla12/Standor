    ...
    <nav className="fixed top-0 left-0 right-0 z-[100] py-6 pointer-events-none">
      <div className="ns-container flex items-center justify-between pointer-events-none">
        ...
        <div className="flex-1 flex justify-end md:justify-center px-2 md:px-10">
          <div
            className={`relative flex items-center px-3 md:px-6 py-2 rounded-full transition-all duration-300 pointer-events-auto ${
              isScrolled
      ...
      {/* Mobile Menu */}
      <div
        className={`fixed inset-0 z-[-1] bg-ns-bg-900/95 backdrop-blur-2xl transition-all duration-500 md:hidden ${
          mobileOpen
            ? "opacity-100"
